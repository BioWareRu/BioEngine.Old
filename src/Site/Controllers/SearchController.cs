    ...
    public class SearchController : BaseController
    {
        ...
        public async Task<IActionResult> Index(string query, string block)
        {
            ...
            if (!hasBlock || block == "articlesCats")
            {
                ...
                var searchBlock = CreateSearchBlock("Категории статей", UrlManager.Search.BlockUrl("articlesCats", query),
                    articlesCatsCount,
            ...
            if (!hasBlock || block == "filesCat")
            {
                ...
                var searchBlock = CreateSearchBlock("Категории файлов", UrlManager.Search.BlockUrl("filesCat", query),
                    fileCatsCount,
                    fileCats, x => x.Title,
            ...
            if (!hasBlock || block == "galleryCats")
            {
                ...
                var searchBlock = CreateSearchBlock("Категории картинок", UrlManager.Search.BlockUrl("galleryCats", query),
                    galleryCatsCount,
